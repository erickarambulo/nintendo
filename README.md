...
The [analysis.md](https://github.com/erickarambulo/nintendo/blob/main/analysis.md) file also contains analyses and data visualizations that I created by using Python in Jupyter Notebook as an IDE.
