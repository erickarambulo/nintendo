...
The [analyses.md](https://github.com/erickarambulo/nintendo/blob/main/analyses.md) file also contains analyses and data visualizations that I created by using Python in Jupyter Notebook as an IDE.
